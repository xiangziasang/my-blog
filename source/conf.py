...
latex_documents = [
  ('index', 'python3-cookbook.tex', u'Bear\'s BLOG',
   u'Bear', 'howto'),
]
...
man_pages = [
    ('index', 'python3-cookbook', u'Bear\'s BLOG',
     [u'Bear'], 1)
]
...
texinfo_documents = [
  ('index', 'Python-Time', u'Bear\'s BLOG,',
   u'Bear', 'Python-Time', 'Bear\'s BLOG,',
   'Miscellaneous'),
]
